...
public class CategoryPage {
	...
	private List<WebDriver> categoryList;
...
//Utilization
	...
	public List<WebDriver> getCategoryList() {
		return categoryList;
	}
	...
	public void clickDeleButton(String courseName, WebDriver driver) {
		String required = String.format(deletePath, courseName);
